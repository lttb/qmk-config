...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_DEF] = LAYOUT_all(
    ...
    KC_F5, KC_F6,  BASE_ESC, KC_A,    KC_S,    KC_D,    KC_F,         KC_G,   KC_H,  KC_J,         KC_K,    KC_L,    KC_ENT,  KC_QUOT,   KC_NUHS,        KC_ENT,  KC_PGUP,
    KC_F7, KC_F8,  KC_LSFT,  KC_NUBS, KC_Z,    KC_X,    KC_C,         KC_V,   KC_B,  KC_N,         KC_M,    KC_COMM, KC_DOT,  BASE_SLSH, SFT_T(KC_SCLN), KC_UP,   KC_PGDN,
