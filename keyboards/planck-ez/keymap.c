...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_DEF] = LAYOUT_wrapper(
        ...
        ___________, __________BASE_3_LT___________, __________BASE_3_RT___________, XXXXXXX, XXXXXXX, QK_BOOT
    ),
    ...
    [_SYM] = LAYOUT_wrapper(
        ...
        ___________, __________SYMB_3_LT___________, __________SYMB_3_RT___________, ___________
    ),
    ...
    [_NAV] = LAYOUT_wrapper(
        ...
        ___________, __________NAVI_3_LT___________, __________NAVI_3_RT___________, ___________
    ),
    ...
    [_NUM] = LAYOUT_wrapper(
        ...
        ___________, __________NUMB_3_LT___________, __________NUMB_3_RT___________, ___________
    ),
    ...
    [_MOUSE] = LAYOUT_wrapper(
        ...
        ___________, __________MOUS_3_LT___________, __________MOUS_3_RT___________, ___________    
    ),
    ...
    [_SCRL] = LAYOUT_wrapper(
        ...
        ___________, __________SCRL_3_LT___________, __________SCRL_3_RT___________, ___________    
    ),
