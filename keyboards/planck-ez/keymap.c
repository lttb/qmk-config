...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_DEF] = LAYOUT_wrapper(
        ...
        ___________, __________BASE_3_LT___________, KC_NO, __________BASE_3_RT___________, XXXXXXX, XXXXXXX
    ),
    ...
    [_SYM] = LAYOUT_wrapper(
        ...
        ___________, __________SYMB_3_LT___________, KC_NO, __________SYMB_3_RT___________, XXXXXXX, QK_BOOT
    ),
