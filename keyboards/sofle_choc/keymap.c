/**
 * Based on the default keymap for the sofle_choc keyboard
 * @see https://github.com/qmk/qmk_firmware/pull/16736
 */
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SCRL] = LAYOUT_wrapper(
        ...
        _________________SCRL_6_L3_________________,   _______, _______,    _________________SCRL_6_R3_________________,
              XXXXXXX, XXXXXXX, __________SCRL_3_LT___________, __________SCRL_3_RT___________, XXXXXXX, XXXXXXX
    ),
